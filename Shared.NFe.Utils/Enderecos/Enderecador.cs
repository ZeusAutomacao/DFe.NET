...
namespace NFe.Utils.Enderecos
{
    public static class Enderecador
    {
        ...
        private static List<EnderecoServico> CarregarEnderecosServicos()
        {
            ...
            {
                if (emissao != TipoEmissao.teEPEC)
                    addServico(eventoCceCanc, versao1, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.CartaCorrecaoCancelamentoHomologacao_VersaoUm);
                addServico(new[] { ServicoNFe.NfeRecepcao }, versao2, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeRecepcaoHomologacao_VersaoDois);
                addServico(new[] { ServicoNFe.NfeRetRecepcao }, versao2, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeRetRecepcaoHomologacao_VersaoDois);
                addServico(new[] { ServicoNFe.NfeInutilizacao }, versao2E3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeInutilizacaoHomologacao_VersaoDoisETres);
                addServico(new[] { ServicoNFe.NfeConsultaProtocolo }, versao2E3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeConsultaProtocoloHomologacao_VersaoDoisETres);
                addServico(new[] { ServicoNFe.NfeStatusServico }, versao2E3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeStatusServicoHomologacao_VersaoDoisETres);
                addServico(new[] { ServicoNFe.NfeConsultaCadastro }, versao2E3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeConsultaCadastroHomologacao_VersaoDoisETres);
                addServico(new[] { ServicoNFe.NfeDownloadNF }, versao2E3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeDownloadNFHomologacao_VersaoDoisETres);
                addServico(new[] { ServicoNFe.NFeAutorizacao }, versao3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NFeAutorizacaoHomologacao_VersaoTres);
                addServico(new[] { ServicoNFe.NFeRetAutorizacao }, versao3, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NFeRetAutorizacaoHomologacao_VersaoTres);

                addServico(eventoCceCanc, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.CartaCorrecaoCancelamentoHomologacao_VersaoQuatro);
                addServico(new[] { ServicoNFe.NfeInutilizacao }, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeInutilizacaoHomologacao_VersaoQuatro);
                addServico(new[] { ServicoNFe.NfeConsultaProtocolo }, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeConsultaProtocoloHomologacao_VersaoQuatro);
                addServico(new[] { ServicoNFe.NfeStatusServico }, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NfeStatusServicoHomologacao_VersaoQuatro);
                addServico(new[] { ServicoNFe.NFeAutorizacao }, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NFeAutorizacaoHomologacao_VersaoQuatro);
                addServico(new[] { ServicoNFe.NFeRetAutorizacao }, versao4, hom, emissao, Estado.CE, nfe, ConfiguracaoServico.Instancia.FactoryUrl.Ceara.NFeRetAutorizacaoHomologacao_VersaoQuatro);
            }
