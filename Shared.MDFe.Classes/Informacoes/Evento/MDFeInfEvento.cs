...
namespace MDFe.Classes.Informacoes.Evento
{
    ...
    {
        [XmlIgnore]
        private readonly VersaoServico _versaoServico;// = MDFeConfiguracao.SingletonInstance.VersaoWebService.VersaoLayout;

        public MDFeInfEvento(VersaoServico versaoServico)
        {
