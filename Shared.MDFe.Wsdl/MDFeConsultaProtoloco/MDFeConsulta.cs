...
namespace MDFe.Wsdl.MDFeConsultaProtoloco
{
    public class MDFeConsulta
    {
        ...
        public async Task<XmlNode> mdfeConsultaMDFAsync(XmlNode mdfeDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                mdfeDadosMsg = mdfeDadosMsg
            };
            return await RequestBuilderAndSender.ExecuteAsync(soapEnvelope, WsdlConfiguracao, TipoEvento.MDFeConsulta, "retConsSitMDFe");
        }
