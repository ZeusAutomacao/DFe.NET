...
namespace MDFe.Wsdl.MDFeConsultaNaoEncerrados
{
    public class MDFeConsNaoEnc
    {
        ...
        public async Task<XmlNode> mdfeConsNaoEncAsync(XmlNode mdfeDadosMsg)
        {
            soapEnvelope.body = new ResponseBody<XmlNode>
            {
                mdfeDadosMsg = mdfeDadosMsg
            };
            return await RequestBuilderAndSender.ExecuteAsync(soapEnvelope, WsdlConfiguracao, TipoEvento.MDFeNaoEncerrado, "retConsMDFeNaoEnc");
        }
