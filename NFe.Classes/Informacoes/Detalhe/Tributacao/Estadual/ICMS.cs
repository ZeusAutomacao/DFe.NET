...
namespace NFe.Classes.Informacoes.Detalhe.Tributacao.Estadual
{
    public class ICMS
    {
        ...
        ///     <para>N02a (ICMS02) - Grupo Tributação do ICMS monofásico  = 02 </para>
        ///     <para>N03 (ICMS10) - Grupo Tributação do ICMS = 10 </para>
        ///     <para>N03a (ICMS15) - Grupo Tributação do ICMS monofásico  = 15 </para>
        ...
        ///     <para>N07a (ICMS53) - Grupo Tributação do ICMS monofásico  = 53 </para>
        ///     <para>N08 (ICMS60) - Grupo Tributação do ICMS = 60</para>
        ///     <para>N08a (ICMS61) - Grupo Tributação do ICMS monofásico  = 61 </para>
        ...
        [XmlElement("ICMS02", typeof(ICMS02))]
        [XmlElement("ICMS10", typeof(ICMS10))]
        [XmlElement("ICMS15", typeof(ICMS15))]
        ...
        [XmlElement("ICMS53", typeof(ICMS53))]
