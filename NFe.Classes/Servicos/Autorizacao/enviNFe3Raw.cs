...
//    public class enviNFe3Raw
//    {
//        private const string elementName = "enviNFe";
//        private const string Namespace = "http://www.portalfiscal.inf.br/nfe";

//        public enviNFe3Raw(string versao, int idLote, IndicadorSincronizacao indSinc, List<NFe> nFe)
//        {
//            this.versao = versao;
//            this.idLote = idLote;
