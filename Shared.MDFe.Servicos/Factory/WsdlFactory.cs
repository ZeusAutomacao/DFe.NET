...
namespace MDFe.Servicos.Factory
{
    ...
    {
        public static MDFeConsNaoEnc CriaWsdlMDFeConsNaoEnc(MDFeConfiguracao config)
        {
        ...
        public static MDFeConsulta CriaWsdlMDFeConsulta(MDFeConfiguracao config)
        {
        ...
        public static MDFeRecepcaoEvento CriaWsdlMDFeRecepcaoEvento(MDFeConfiguracao config)
        {
        ...
        public static MDFeRecepcao CriaWsdlMDFeRecepcao(MDFeConfiguracao config)
        {
        ...
        public static MDFeRetRecepcao CriaWsdlMDFeRetRecepcao(MDFeConfiguracao config)
        {
        ...
        public static MDFeStatusServico CriaWsdlMDFeStatusServico(MDFeConfiguracao config)
        {
        ...
        private static WsdlConfiguracao CriaConfiguracao(string url, string versao, MDFeConfiguracao config)
        {
