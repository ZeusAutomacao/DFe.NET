...
namespace NFe.Danfe.Nativo.NFCe
{
    public class DanfeNativoNfce
    {
        ...
        private void GerarNfCe(Graphics graphics)
        {
            ...
            #endregion preencher itens

            #endregion tabela de itens
            ...
            foreach (detPag pag in _nfe.infNFe.pag.detPags)
            {
        ...
        private static string ObtemDescricao(detPag pag)
        {
            switch (pag.tPag)
            {
