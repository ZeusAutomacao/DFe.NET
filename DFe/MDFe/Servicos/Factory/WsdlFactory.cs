...
using DFe.MDFe.Wsdl.Gerado.MDFeEventos;
using DFe.MDFe.Wsdl.Gerado.MDFeRecepcao;
using DFe.MDFe.Wsdl.Gerado.MDFeRetRecepcao;
using DFe.MDFe.Wsdl.Gerado.MDFeStatusServico;
