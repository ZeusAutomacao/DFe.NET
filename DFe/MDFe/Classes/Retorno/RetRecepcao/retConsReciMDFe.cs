...
namespace DFe.MDFe.Classes.Retorno.RetRecepcao
{
    ...
    public class retConsReciMDFe : RetornoBase
    {
        ...
        public static retConsReciMDFe LoadXml(string xml)
        {
            var retorno = FuncoesXml.XmlStringParaClasse<retConsReciMDFe>(xml);
            retorno.RetornoXmlString = xml;

            return retorno;
        }

        public static retConsReciMDFe LoadXml(string xml, consReciMDFe consReciMdfe)
        {
