...
namespace DFe.MDFe.Classes.Retorno.Evento
{
    ...
    public class retEventoMDFe : RetornoBase
    {
        ...
        public static retEventoMDFe LoadXml(string xml)
        {
            var retorno = FuncoesXml.XmlStringParaClasse<retEventoMDFe>(xml);
            retorno.RetornoXmlString = xml;

            return retorno;
        }

        public static retEventoMDFe LoadXml(string xml, eventoMDFe evento)
        {
