...
namespace DFe.DocumentosEletronicos.NFe.Utils.Excecoes
{
    /// <summary>
    ...
    public class ComunicacaoException : Exception
    {
        ...
        public ComunicacaoException(ServicoNFe servico, string message) : base(string.Format((string) "Sem comunicação com o serviço {0}:\n{1}", (object) servico, message)){}
    }
}
