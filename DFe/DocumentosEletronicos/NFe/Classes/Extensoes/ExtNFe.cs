...
using DFe.DocumentosEletronicos.NFe.Assinatura;
...
namespace DFe.DocumentosEletronicos.NFe.Classes.Extensoes
{
    public static class ExtNFe
    {
        ...
        public static Informacoes.NFe CarregarDeArquivoXml(this Informacoes.NFe nfe, string arquivoXml)
        {
            var s = FuncoesXml.ObterNodeDeArquivoXml(typeof (Informacoes.NFe).Name, arquivoXml);
            return FuncoesXml.XmlStringParaClasse<Informacoes.NFe>(s);
        }
        ...
        public static string ObterXmlString(this Informacoes.NFe nfe)
        {
        ...
        public static Informacoes.NFe CarregarDeXmlString(this Informacoes.NFe nfe, string xmlString)
        {
            var s = FuncoesXml.ObterNodeDeStringXml(typeof (Informacoes.NFe).Name, xmlString);
            return FuncoesXml.XmlStringParaClasse<Informacoes.NFe>(s);
        }
        ...
        public static void SalvarArquivoXml(this Informacoes.NFe nfe, string arquivoXml)
        {
        ...
        public static Informacoes.NFe Valida(this Informacoes.NFe nfe)
        {
        ...
        public static Informacoes.NFe Assina(this Informacoes.NFe nfe)
        {
            var nfeLocal = nfe;
