...
using DFe.DocumentosEletronicos.NFe.Classes.Protocolo;
using DFe.Entidades;

namespace DFe.DocumentosEletronicos.NFe.Classes.Servicos.Recepcao.Retorno
{
    [XmlRoot(Namespace = "http://www.portalfiscal.inf.br/nfe")]
    public class retConsReciNFe : IRetornoServico
    {
        /// <summary>
