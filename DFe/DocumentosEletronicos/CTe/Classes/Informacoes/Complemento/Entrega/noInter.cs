...
using DFe.DocumentosEletronicos.CTe.Classes.Informacoes.Complemento.Tipos;
using DFe.DocumentosEletronicos.CTe.Classes.Informacoes.Tipos;
using DFe.Ext;

namespace DFe.DocumentosEletronicos.CTe.Classes.Informacoes.Complemento.EntregaCTe
{
