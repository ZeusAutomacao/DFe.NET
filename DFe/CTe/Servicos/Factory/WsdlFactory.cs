...
using DFe.CTe.Servicos.Enderecos.Helpers;
using DFe.CTe.Wsdl.Configuracao;
using DFe.CTe.Wsdl.ConsultaProtocolo;
using DFe.CTe.Wsdl.Evento;
using DFe.CTe.Wsdl.Inutilizacao;
using DFe.CTe.Wsdl.Recepcao;
using DFe.CTe.Wsdl.RetRecepcao;
using DFe.CTe.Wsdl.Status;
