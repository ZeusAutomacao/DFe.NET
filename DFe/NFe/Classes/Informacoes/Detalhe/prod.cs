...
using DFe.NFe.Classes.Informacoes.Detalhe.DeclaracaoImportacao;
using DFe.NFe.Classes.Informacoes.Detalhe.Exportacao;
using DFe.NFe.Classes.Informacoes.Detalhe.ProdEspecifico;

namespace DFe.NFe.Classes.Informacoes.Detalhe
{
    public class prod
    {
        public prod()
