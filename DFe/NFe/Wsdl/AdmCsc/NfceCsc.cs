...
namespace DFe.NFe.Wsdl.AdmCsc
{
    ...
    public class NfceCsc : SoapHttpClientProtocol, INfeServico
    {
        ...
        [return: XmlElement("cscNFCeResult", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CscNFCe")]
        public XmlNode Execute([XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CscNFCe")] XmlNode nfeDadosMsg)
         {
