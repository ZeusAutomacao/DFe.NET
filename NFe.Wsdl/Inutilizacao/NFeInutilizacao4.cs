...
namespace NFe.Wsdl.Inutilizacao
{
    ...
    public class nfeInutilizacao4NFRequest
    {
    ...
    [EditorBrowsable(EditorBrowsableState.Advanced)]
    [MessageContract(IsWrapped = false)]
    public class nfeInutilizacao4NFResponse
    {
        [MessageBodyMember(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", Order = 0)]
    ...
    [ServiceContract(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4",
        ConfigurationName = "NFeInutilizacao4Soap12")]
    ...
    public class NFeInutilizacao4Soap12Client : SoapBindingClient<NFeInutilizacao4Soap12>
    {
        public NFeInutilizacao4Soap12Client(string endpointAddressUri) : base(endpointAddressUri) { }

        public Task<nfeInutilizacao4NFResponse> nfeInutilizacao4NFAsync(XmlNode nfeDadosMsg)
        {
            var inValue = new nfeInutilizacao4NFRequest();
            inValue.nfeDadosMsg = nfeDadosMsg;
            return Channel.nfeInutilizacao4NFAsync(inValue);
        }
    }
}