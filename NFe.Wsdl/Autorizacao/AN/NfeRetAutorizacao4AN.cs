...
namespace NFe.Wsdl.Autorizacao.AN
{
    ...
    public class NfeRetAutorizacao4AN : SoapHttpClientProtocol, INfeServico
    {
        public NfeRetAutorizacao4AN(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement("nfeRetAutorizacaoLoteResult", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4")]
