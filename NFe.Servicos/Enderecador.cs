    ...
    public static class Enderecador
    {
        ...
        private static List<EnderecoServico> CarregarUrlsServicos()
        {
            ...
            foreach (var emissao in emissaoComum)
            {
                ...
                endServico.Add(new EnderecoServico(ServicoNFe.NfeConsultaCadastro, VersaoServico.ve400, TipoAmbiente.taHomologacao, emissao, Estado.MT, ModeloDocumento.NFe, "https://hom.nfe.sefaz.ms.gov.br/ws/CadConsultaCadastro4?wsdl"));
