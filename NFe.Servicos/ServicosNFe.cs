...
namespace NFe.Servicos
{
    public sealed class ServicosNFe : IDisposable
    {
        ...
        public RetornoNfeStatusServico NfeStatusServico()
        {
            ...
            #endregion Cria o objeto consStatServ

            #region Valida, Envia os dados e obtém a resposta

            var xmlStatus = pedStatus.ObterXmlString();
            Validador.Valida(ServicoNFe.NfeStatusServico, _cFgServico.VersaoNfeStatusServico, xmlStatus, _cFgServico);
            ...
            #endregion Valida, Envia os dados e obtém a resposta
        }
        ...
        public RetornoNfeConsultaProtocolo NfeConsultaProtocolo(string chave)
        {
            ...
            #endregion Cria o objeto consSitNFe

            #region Valida, Envia os dados e obtém a resposta

            var xmlConsulta = pedConsulta.ObterXmlString();
            Validador.Valida(ServicoNFe.NfeConsultaProtocolo, _cFgServico.VersaoNfeConsultaProtocolo, xmlConsulta, _cFgServico);
            ...
            int numeroInicial, int numeroFinal, string justificativa)
        {
            ...
            #endregion Cria o objeto inutNFe

            #region Valida, Envia os dados e obtém a resposta

            var xmlInutilizacao = pedInutilizacao.ObterXmlString();
            Validador.Valida(ServicoNFe.NfeInutilizacao, _cFgServico.VersaoNfeInutilizacao, xmlInutilizacao, _cFgServico);
        ...
        private RetornoRecepcaoEvento RecepcaoEvento(int idlote, List<evento> eventos, ServicoNFe servicoEvento, string nomeDoArquivo = null)
        {
            ...
            #endregion Cria o objeto envEvento

            #region Valida, Envia os dados e obtém a resposta

            var xmlEvento = pedEvento.ObterXmlString();
            Validador.Valida(servicoEvento, _cFgServico.VersaoRecepcaoEventoCceCancelamento, xmlEvento, _cFgServico);
            ...
            if (string.IsNullOrWhiteSpace(nomeDoArquivo))
                ...
                SalvarArquivoXml(nomeDoArquivo + "-ped-eve.xml", xmlEvento);
            ...
            if (string.IsNullOrWhiteSpace(nomeDoArquivo))
                ...
                SalvarArquivoXml(nomeDoArquivo + "-eve.xml", retornoXmlString);
            ...
            #endregion Obtém um procEventoNFe de cada evento e salva em arquivo
        ...
        public RetornoRecepcaoEvento RecepcaoEventoCancelamento(int idlote, int sequenciaEvento,
            string protocoloAutorizacao, string chaveNFe, string justificativa, string cpfcnpj, string nomeDoArquivo = null)
        {
            var versaoServico =
            ...
            var retorno = RecepcaoEvento(idlote, new List<evento> { evento }, ServicoNFe.RecepcaoEventoCancelmento, nomeDoArquivo);
            return retorno;
        }
        ...
        public RetornoRecepcaoEvento RecepcaoEventoCartaCorrecao(int idlote, int sequenciaEvento, string chaveNFe,
            string correcao, string cpfcnpj, string nomeDoArquivo = null)
        {
            var versaoServico =
            ...
            var retorno = RecepcaoEvento(idlote, new List<evento> { evento }, ServicoNFe.RecepcaoEventoCartaCorrecao, nomeDoArquivo);
            return retorno;
        }
            ...
            string veraplic)
        {
            ...
            if (string.IsNullOrEmpty(nfe.infNFe.Id))
                nfe.Assina(_cFgServico.Certificado.Certificado).Valida(_cFgServico);
            ...
            string documento)
        {
            ...
            #endregion Cria o objeto ConsCad

            #region Valida, Envia os dados e obtém a resposta

            var xmlConsulta = pedConsulta.ObterXmlString();
            Validador.Valida(ServicoNFe.NfeConsultaCadastro, _cFgServico.VersaoNfeConsultaCadastro, xmlConsulta, _cFgServico);
            var dadosConsulta = new XmlDocument();
            dadosConsulta.LoadXml(xmlConsulta);
            ...
            string nSU = "0")
        {
            ...
            #endregion Cria o objeto distDFeInt

            #region Valida, Envia os dados e obtém a resposta

            var xmlConsulta = pedDistDFeInt.ObterXmlString();
            Validador.Valida(ServicoNFe.NFeDistribuicaoDFe, _cFgServico.VersaoNFeDistribuicaoDFe, xmlConsulta, _cFgServico);
            var dadosConsulta = new XmlDocument();
            dadosConsulta.LoadXml(xmlConsulta);
            ...
            #endregion Obtém um retDistDFeInt de cada evento e salva em arquivo
        ...
        public RetornoNfeRecepcao NfeRecepcao(int idLote, List<Classes.NFe> nFes)
        {
            ...
            #endregion Cria o objeto enviNFe
            ...
            Validador.Valida(ServicoNFe.NfeRecepcao, _cFgServico.VersaoNfeRecepcao, xmlEnvio, _cFgServico);
        ...
        public RetornoNfeRetRecepcao NfeRetRecepcao(string recibo)
        {
            ...
            #endregion Cria o objeto consReciNFe
            ...
            #endregion Envia os dados e obtém a resposta
        }
        ...
        public RetornoNFeAutorizacao NFeAutorizacao(int idLote, IndicadorSincronizacao indSinc, List<Classes.NFe> nFes,
            bool compactarMensagem = false, string nomeDoArquivo = null)
        {
            ...
            if (string.IsNullOrWhiteSpace(nomeDoArquivo))
                ...
                SalvarArquivoXml(nomeDoArquivo + "-env-lot.xml", xmlEnvio);
            ...
            if (string.IsNullOrWhiteSpace(nomeDoArquivo))
                ...
                SalvarArquivoXml(nomeDoArquivo + "-rec.xml", retornoXmlString);
        ...
        public RetornoNfeDownload NfeDownloadNf(string cnpj, List<string> chaves)
        {
            ...
            #endregion Cria o objeto wdsl para envio do pedido de Download
            ...
            #endregion Cria o objeto downloadNFe

            #region Valida, Envia os dados e obtém a resposta

            var xmlDownload = pedDownload.ObterXmlString();
            Validador.Valida(ServicoNFe.NfeDownloadNF, _cFgServico.VersaoNfeDownloadNF, xmlDownload, _cFgServico);
        ...
        #endregion Implementação do padrão Dispose
    }
}