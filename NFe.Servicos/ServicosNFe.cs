...
namespace NFe.Servicos
{
    public sealed class ServicosNFe : IDisposable
    {
        ...
        private RetornoRecepcaoEvento RecepcaoEvento(long idLote, List<evento> eventos, ServicoNFe servicoEvento)
        {
        ...
        /// <returns>Retorna um objeto da classe RetornoRecepcaoEvento com o retorno do serviço RecepcaoEvento</returns>
        public RetornoRecepcaoEvento RecepcaoEventoCancelamento(long idLote, int sequenciaEvento,
        ...
        /// <param name="cpfcnpj"></param>
        /// <returns>Retorna um objeto da classe RetornoRecepcaoEvento com o retorno do serviço RecepcaoEvento</returns>
        public RetornoRecepcaoEvento RecepcaoEventoCartaCorrecao(long idLote, int sequenciaEvento, string chaveNFe,
        ...
        public RetornoRecepcaoEvento RecepcaoEventoManifestacaoDestinatario(long idLote, int sequenciaEvento,
        ...
        /// <returns>Retorna um objeto da classe RetornoRecepcaoEvento com o retorno do serviço RecepcaoEvento</returns>
        public RetornoRecepcaoEvento RecepcaoEventoEpec(long idLote, int sequenciaEvento, Classes.NFe nfe,
            string veraplic)
        {
            var versaoServico =
        ...
        public RetornoNfeRecepcao NfeRecepcao(long idLote, List<Classes.NFe> nFes)
        {
        ...
        public RetornoNFeAutorizacao NFeAutorizacao(long idLote, IndicadorSincronizacao indSinc, List<Classes.NFe> nFes,
        ...
        private RetornoNFeAutorizacao NFeAutorizacao4(long idLote, IndicadorSincronizacao indSinc, List<Classes.NFe> nFes, bool compactarMensagem)
        {
        ...
        private RetornoNFeAutorizacao NFeAutorizacaoVersao310(long idLote, IndicadorSincronizacao indSinc, List<Classes.NFe> nFes, bool compactarMensagem)
        {
            var versaoServico = ServicoNFe.NFeAutorizacao.VersaoServicoParaString(_cFgServico.VersaoNFeAutorizacao);
