...
{
    /// <summary>
    /// Classe responsável por realizar as consultas SOAP do tipo Status via HttpClient.
        ...
        public async Task<System.Xml.XmlNode> mdfeStatusServicoMDF(System.Xml.XmlNode mdfeDadosMsg)
        {
            ...
            soapConfig = new SoapConfig
            {
                Cabecalho = new Cabecalho(estado, versaoServico,
                    new TagCabecalho(), "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico",
                    TipoRequisicao.MDFe),
                Corpo = new Corpo("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico", tagcorpo),
