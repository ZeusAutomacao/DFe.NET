...
{
    /// <summary>
    /// Classe responsável por realizar as consultas SOAP do tipo Recepção Evento via HttpClient.
    ...
    public partial class MDFeRecepcaoEvento
    {
        ...
        public async Task<System.Xml.XmlNode> mdfeRecepcaoEvento(System.Xml.XmlNode mdfeDadosMsg)
        {
            ...
            soapConfig = new SoapConfig
            {
                Cabecalho = new Cabecalho(estado, versaoServico,
                    new TagCabecalho(), "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento",
                    TipoRequisicao.MDFe),
                Corpo = new Corpo("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoEvento", tagcorpo),
