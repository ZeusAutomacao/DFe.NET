...
#if NET45
    [System.Web.Services.WebServiceBindingAttribute(Name = "MDFeRetRecepcaoSoap12", Namespace =
 "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRetRecepcao")]
    ...
    public partial class MDFeRetRecepcao
    {
        ...
        public System.Xml.XmlNode mdfeRetRecepcao(System.Xml.XmlNode mdfeDadosMsg)
        {
            ...
            var tes = soapUtils.MdfeEncHttpClient(xmlEnvelop, configuracao.CertificadoDigital, configuracao.Url, Tipo.MDFeRetRecepcao);
