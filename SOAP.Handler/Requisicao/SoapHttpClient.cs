...
namespace SOAP.Handler.Requisicao
{
    ...
    {
        /// <summary>
        /// Requisição via HttpClient com protocolo SOAP.
        /// </summary>
        /// <param name="soapConfig"></param>
        /// <returns>Task<string> resposta</returns>
        public async Task<string> Invoke(SoapConfig soapConfig)
        {
            var request = new RequestWsdl();
            return await request.SendRequest(soapConfig);
        }

        /// <summary>
        /// Conversão da Tag do xml obtido.
        /// </summary>
