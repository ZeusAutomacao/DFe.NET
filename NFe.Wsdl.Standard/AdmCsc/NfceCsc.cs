    ...
    public class NfceCsc : INfeServico
    {
        ...
        public XmlNode Execute(XmlNode nfeDadosMsg)
        {
            ...
            return RequestBuilderAndSender.Execute(soapEnvelope, configuracao,
                actionUrn: "http://www.portalfiscal.inf.br/nfe/wsdl/CscNFCe/admCscNFCe",
                responseElementName: "cscNFCeResult").FirstChild;
        }
        ...
        {
            [XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CscNFCe")]
