...
{
    public class NfeRetAutorizacao3 : INfeServico
    {
        public NfeRetAutorizacao3(string url, X509Certificate certificado, int timeOut)
        {
            throw new NotImplementedException("NfeRetAutorizacao 3.0 não está implementado para .net standard, apenas .net framework");
        }
