...
{
    public class NFeInutilizacao4SVAN : INfeServico
    {
        ...
        public XmlNode Execute(XmlNode nfeDadosMsg)
        {
            ...
            return RequestBuilderAndSender.Execute(soapEnvelope, configuracao,
                actionUrn: "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4/nfeInutilizacaoNF",
        ...
        {
            [XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4")]
