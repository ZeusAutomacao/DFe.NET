...
{
    public class NfeInutilizacao : INfeServico
    {
        public NfeInutilizacao(string url, X509Certificate certificado, int timeOut)
        {
            throw new NotImplementedException("NfeInutilizacao 1.0 não está implementado para .net standard, apenas .net framework");
        }
